...
class NetworkModule {
    ...
    @Singleton
    @Provides
    fun provideService(retrofit: Retrofit): InfosysService {
        return retrofit.create(InfosysService::class.java)
    }

    @Singleton
    @Provides
    fun provideFactRemoteDataSource(service: InfosysService) =
        FactRemoteDataSource(service)
}